  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Book Content */}
        <Card className="bg-[#121212] backdrop-blur-sm border-border shadow-lg mb-6 sm:mb-8">
          <CardContent className="p-4 sm:p-6">
            <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4 sm:mb-6">Conteúdo do Livro</h2>

            <div className="max-w-none text-[#f2f2f2] space-y-3 sm:space-y-4 font-sans">
              <p className="text-base sm:text-lg leading-relaxed mb-3 font-['Inter',_'Roboto',_'Helvetica',_sans-serif] leading-[1.65]">
