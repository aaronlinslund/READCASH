            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <Card className="bg-card/80 backdrop-blur-sm border-border shadow-lg">
                <CardContent className="p-2 sm:p-3 text-center">
                  ...
                  <h3 className="text-xs sm:text-sm font-semibold text-white mb-1">Comunidade</h3>
                  <p className="text-xs text-gray-300 mb-1 sm:mb-2">Rankings e reviews</p>
                  <Button
                    variant="outline"
                    className="w-full border-primary text-white hover:bg-primary/10 bg-transparent text-xs py-1 h-6 sm:h-7"
              ...
              <Card className="bg-card/80 backdrop-blur-sm border-border shadow-lg">
                <CardContent className="p-2 sm:p-3 text-center">
                  ...
                  <h3 className="text-xs sm:text-sm font-semibold text-white mb-1">Biblioteca</h3>
                  <p className="text-xs text-gray-300 mb-1 sm:mb-2">Ver biblioteca completa</p>
                  <Button
                    variant="outline"
                    className="w-full border-accent text-white hover:bg-accent/10 bg-transparent text-xs py-1 h-6 sm:h-7"
