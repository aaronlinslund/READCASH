          ...
          <div className="p-6">
            ...
            <Card className="bg-gradient-to-r from-red-600 to-red-700 text-white mb-6 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-200 mb-4">
                  Tempo de leitura: <strong className="text-white">{formatTime(readingTimeSeconds)}</strong>
                </p>
            ...
            <Card className="bg-yellow-50 border-yellow-200 mb-6">
              <CardContent className="p-4">
                <h4 className="font-semibold text-white mb-2">⚠️ Por que isso aconteceu?</h4>
